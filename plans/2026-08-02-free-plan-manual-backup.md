# [구현 완료·최초 실행 대기] Supabase Free 플랜 수동 백업 체계 계획
...
4. [ ] 사용자가 본인 CMD에서 Supabase CLI 로그인·프로젝트 연결을 한 뒤 첫 백업을 실행한다. 비밀번호·토큰은 Codex에 보내지 않는다.
5. [ ] 생성된 파일 존재·해시 매니페스트·Git 미추적 상태를 확인한다.
